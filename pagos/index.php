      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-gray-50">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
              ...
              <td class="px-5 py-3">
                <div class="flex items-center justify-center gap-2">
                  <a href="<?= APP_URL ?>/pagos/editar.php?id=<?= $p['id'] ?>"
                     title="Editar pago"
                  ...
                  <a href="<?= APP_URL ?>/pagos/eliminar.php?id=<?= $p['id'] ?>"
                     title="Eliminar pago"
                     onclick="return confirm('¿Eliminar el pago <?= e($p['numero_recibo'] ?? '') ?>? Esta acción no se puede deshacer.')"
            ...
            <?php endforeach; ?>
            <?php if (empty($pagos)): ?>
              <tr><td colspan="8" class="px-5 py-12 text-center text-gray-400">No hay pagos registrados.</td></tr>
            <?php endif; ?>
          </tbody>
        </table>
      </div>
